...
<template>
    <div>
        ...
        <FeedItemPopup :feed="currentFeed" :feedItem="feedItem" ref="feedItemProp"></FeedItemPopup>
...
export default defineNuxtComponent({
    ...
    components: {
        FeedItemPopup,Check,Refresh,Select,Share,Reading,More,Link,Paperclip,FullScreen,CollectionTag
    },
