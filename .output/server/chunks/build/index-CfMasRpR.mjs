...
const _sfc_main = defineNuxtComponent({
  ...
  async asyncData() {
    ...
    let feedItems = [];
    let totalCount = 0;
    let responseData = ([__temp, __restore] = executeAsync(() => rssbiz.queryFeedItemsByFeedIDV2(true, "0", 1, 30, (pageNumber - 1) * 30)), __temp = await __temp, __restore(), __temp);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/article/page/[[pageNumber]].html/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { index as default };
//# sourceMappingURL=index-CfMasRpR.mjs.map
