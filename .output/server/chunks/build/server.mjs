...
const _routes = [
  ...
  },
  {
    ...
    path: "/feed/wx-public-account/:mp_id?",
    component: () => import('./index-DYX8mREz.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    component: () => import('./index-CNePY4LY.mjs').then((m) => m.default || m)
  },
  {
    name: "my-all",
    path: "/my/all",
...
const helper = {
  ...
  getCookie(name) {
    var cookies = (void 0).cookie ? (void 0).cookie.split("; ") : [];
    let val = "";
  ...
  getMst() {
    ...
    if (mstText != "" || mstText != null && mstText != void 0) {
      try {
  ...
  getUserToken() {
    let mst = this.getMst();
    if (mst != null && mst != void 0) {
      if (mst.t != null && mst.t != void 0 && mst.t.length > 0) {
        return mst.t;
      }
    }
    return "";
  ...
  isMobile() {
    let flag = (void 0).userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i);
    return flag;
  },
  ...
  async getUploadFileSignParam(deviceID, fileName, fileSize) {
    ...
    var data = { fileType: 3, fileName, fileSize, token: deviceID };
    return this.postClientJsonAsync(apiURL, data);
  },
  async getUploadFileSignParamV2(fileType, deviceID, fileName, fileSize) {
    var apiURL = "/api/tbs/v2/file/upload";
    var data = { fileType: parseInt(fileType), fileName, fileSize, token: deviceID };
    return this.postClientJsonAsync(apiURL, data);
  },
  dateFormat(fmt, date) {
    var ret = "";
...
function device_45global(context) {
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BfDbx-sH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-CLJuenPn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-CVii2HP7.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CaGT3eTm.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-D6Yf_0gQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BFo5_unM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-IMAqmOmC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DPmKokn8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-mHoo2FAG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-CRK9L_x1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-C9ZG30_N.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Dyq-Uqrq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-0EEDaG-8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-DMKhY_jU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DQIUiFPm.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-Cxukv5WS.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-jMXIfIeC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-T-9sCB5D.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-DfDL0W2C.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CXnjY_6K.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-C3j1llb_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-BZyUvg4J.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-CEDJ-N4o.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-BeL6-_z-.mjs').then((r) => r["default"] || r.default || r));
...
const devicebiz = {
  ...
  getDeviceID() {
    ...
    try {
      ...
      if (deviceInfo != null) {
        if (deviceInfo.deviceID != null && deviceInfo.deviceID != void 0 && deviceInfo.deviceID.length > 0) {
  ...
  async registerDevice() {
    let responseData = await helper.postClientJsonAsync("/api/tbs/memo/device/register-by-useragent", { user_agent: (void 0).userAgent });
    if (helper.isResultOk(responseData)) {
      let deviceID = responseData.data.device_id;
      let userAgent = responseData.data.user_agent;
      let deviceObject = { deviceID, userAgent };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CryYQ1ie.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DgLPaLXJ.mjs').then((r) => r.default || r));
