...
import { r as readLater } from './read_later-CHodLy6D.mjs';
import { useSSRContext, resolveComponent, withCtx, createVNode } from 'vue';
import { P as Pager } from './Pager-ClphuyoT.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-1b37a448><div style="${ssrRenderStyle({ "max-width": "800px", "margin": "0px auto" })}" data-v-1b37a448><h2 style="${ssrRenderStyle({ "font-size": "34px", "font-weight": "700", "margin-top": "40px", "margin-bottom": "10px" })}" data-v-1b37a448>\u6240\u6709\u6587\u7AE0</h2>`);
  _push(ssrRenderComponent(_component_el_divider, null, null, _parent));
  _push(`<!--[-->`);
  ssrRenderList(_ctx.feedItems, (item, index) => {
    _push(`<div class="feed_item_root_container" data-v-1b37a448>`);
    if (item.thumb_url.length > 0) {
      _push(`<div data-v-1b37a448><div data-v-1b37a448><div data-v-1b37a448>`);
      if (item.feed != null) {
        _push(`<a target="_blank"${ssrRenderAttr("href", item.feed.url)} class="feed_name_img" data-v-1b37a448><img${ssrRenderAttr("src", item.feed.icon_url)} data-v-1b37a448> ${ssrInterpolate(item.feed.name)}${ssrInterpolate(item.authorList.length > 0 ? " \xB7 " + item.authorList[0].author_name : "")}</a>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="feed_item_list_img_container" data-v-1b37a448><img class="feed_item_img"${ssrRenderAttr("src", item.thumb_url)} data-v-1b37a448><div class="feed_item_list_content_container" data-v-1b37a448><a${ssrRenderAttr("href", "/feed-item/" + item.feed_item_id + ".html")} target="_blank" class="feed_item_list_container_title" data-v-1b37a448>${ssrInterpolate(item.title)}</a><div class="feed_item_list_container_extra" data-v-1b37a448><span class="feed_item_list_container_time" data-v-1b37a448>${ssrInterpolate(_ctx.formatHumanTime(item.publish_time))}</span><span data-v-1b37a448>\xA0\xB7\xA0</span><span class="feed_item_list_container_time" data-v-1b37a448>${ssrInterpolate(item.read_count)}\u6B21\u9605\u8BFB</span></div><p class="feed_item_list_container_desc" data-v-1b37a448>${ssrInterpolate(item.desc)}</p><div style="${ssrRenderStyle({ "display": "flex", "margin-top": "5px" })}" data-v-1b37a448><div style="${ssrRenderStyle({ "height": "30px", "line-height": "30px" })}" data-v-1b37a448><span class="feed_item_list_container_time" data-v-1b37a448>${ssrInterpolate(_ctx.formatHumanTime(item.publish_time))}</span><span class="feed_item_list_container_time" data-v-1b37a448>\xA0\xB7\xA0</span><span class="feed_item_list_container_time" data-v-1b37a448>${ssrInterpolate(item.read_count)}\u6B21\u9605\u8BFB</span></div><div style="${ssrRenderStyle({ "flex": "1" })}" data-v-1b37a448></div>`);
      _push(ssrRenderComponent(_component_el_tooltip, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="svg_icon_container_mini" data-v-1b37a448${_scopeId}>`);
      ...
      _push(`<span data-v-1b37a448>\xA0</span>`);
      if (item.readState == 1) {
        _push(ssrRenderComponent(_component_el_tooltip, {
          effect: "dark",
          content: "\u6807\u8BB0\u4E3A\u5DF2\u8BFB",
    ...
    if (item.thumb_url.length == 0) {
      _push(`<div data-v-1b37a448><div class="feed_item_list_container" data-v-1b37a448>`);
      if (item.feed != null) {
        _push(`<a target="_blank"${ssrRenderAttr("href", item.feed.url)} class="feed_name_img" data-v-1b37a448><img${ssrRenderAttr("src", item.feed.icon_url)} data-v-1b37a448> ${ssrInterpolate(item.feed.name)}${ssrInterpolate(item.authorList.length > 0 ? " \xB7 " + item.authorList[0].author_name : "")}</a>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<a${ssrRenderAttr("href", "/feed-item/" + item.feed_item_id + ".html")} target="_blank" class="feed_item_list_container_title" data-v-1b37a448>${ssrInterpolate(item.title)}</a><p class="feed_item_list_container_desc" data-v-1b37a448>${ssrInterpolate(item.desc)}</p></div><div style="${ssrRenderStyle({ "display": "flex", "margin-top": "5px" })}" data-v-1b37a448><div style="${ssrRenderStyle({ "height": "30px", "line-height": "30px" })}" data-v-1b37a448><span class="feed_item_list_container_time" data-v-1b37a448>${ssrInterpolate(_ctx.formatHumanTime(item.publish_time))}</span><span class="feed_item_list_container_time" data-v-1b37a448>\xA0\xB7\xA0</span><span class="feed_item_list_container_time" data-v-1b37a448>${ssrInterpolate(item.read_count)}\u6B21\u9605\u8BFB</span></div><div style="${ssrRenderStyle({ "flex": "1" })}" data-v-1b37a448></div>`);
      _push(ssrRenderComponent(_component_el_tooltip, {
        effect: "dark",
        content: "\u5FEB\u901F\u9605\u8BFB\u6B64\u6587\u7AE0",
        placement: "top-start"
  ...
  _push(ssrRenderComponent(_component_Pager, {
    baseURL: "/feed-item/page",
    activeIndex: _ctx.pageNumber,
    totalCount: _ctx.totalCount
  }, null, _parent));
  _push(`<div style="${ssrRenderStyle({ "height": "30px" })}" data-v-1b37a448></div></div></div>`);
}
...
const FeedItemListSEO = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1b37a448"]]);

export { FeedItemListSEO as F };
//# sourceMappingURL=FeedItemListSEO-C4Qrtdy-.mjs.map
