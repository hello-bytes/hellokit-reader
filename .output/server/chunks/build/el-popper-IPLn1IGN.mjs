import { defineComponent, ref, computed, provide, renderSlot, inject, watch, openBlock, createElementBlock, normalizeClass, unref, normalizeStyle, withDirectives, cloneVNode, Fragment, Text, Comment, createVNode, createBlock, mergeProps, withCtx, createCommentVNode, toRef, Transition, vShow, readonly, toDisplayString, shallowRef, Teleport as Teleport$1, getCurrentInstance } from 'vue';
import { a as buildProp, b as buildProps, d as definePropType, _ as _export_sfc, w as withInstall } from './base-BSYjTNA2.mjs';
import { onClickOutside, tryOnScopeDispose, isClient, unrefElement } from '@vueuse/core';
import { e as useNamespace, q as useId, k as isBoolean, l as useGetDerivedNamespace, m as useIdInjection, p as useZIndex, i as isNumber } from './server.mjs';
import { placements, createPopper } from '@popperjs/core';
import { isNil, pick, isUndefined, fromPairs } from 'lodash-unified';
import { f as formItemContextKey, E as EVENT_CODE } from './constants-XLKnfDE9.mjs';
...
export { ElTooltip as E, FOCUS_TRAP_INJECTION_KEY as F, OnlyChild as O, useTooltipContentProps as a, useTooltipTriggerProps as b, composeEventHandlers as c, ElTeleport as d, ElFocusTrap as e, useAriaProps as u, whenMouse as w };
//# sourceMappingURL=el-popper-IPLn1IGN.mjs.map
