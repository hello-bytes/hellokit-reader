    ...
    toMoney(num, options) {
        ...
        if (options.complete) {
            for (var i = 1; i < this.m_u.length; i++) {
                xs_str += this.CL.call(this, _decimal.charAt(i - 1) || "0") + this.m_u.charAt(i);
            }
            zs_str += this.CL.call(this, _int, options) + this.m_u.charAt(0);
        } else {
            ...
            if (_decimal) {
                ...
                for (var i = 0; i < this.m_u.length - 1; i++) {
                    if (_decimal.charAt(i) && _decimal.charAt(i) != "0") {
                        xs_str += this.CL.call(this, _decimal.charAt(i)) + this.m_u.charAt(i + 1);
                        mark_0 = false;
                    }
